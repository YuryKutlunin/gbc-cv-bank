            ...
            <tbody>
              {employeeSkillList.map((employeeSkill, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{employeeSkill.skill ? <Link to={`skill/${employeeSkill.skill.id}`}>{employeeSkill.skill.id}</Link> : ''}</td>
                  <td>
                    {employeeSkill.skillLevel ? (
                      <Link to={`skill-level/${employeeSkill.skillLevel.id}`}>{employeeSkill.skillLevel.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
