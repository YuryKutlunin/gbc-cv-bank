...
export const SkillDeleteDialog = (props: ISkillDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gbccvBankApp.skill.delete.question">Are you sure you want to delete this Skill?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-skill" color="danger" onClick={confirmDelete}>
