    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>Employee</dt>
          <dd>{educationEntity.employee ? educationEntity.employee.id : ''}</dd>
          <dt>University</dt>
          <dd>{educationEntity.university ? educationEntity.university.id : ''}</dd>
          <dt>Educ Type</dt>
          <dd>{educationEntity.educType ? educationEntity.educType.id : ''}</dd>
        </dl>
