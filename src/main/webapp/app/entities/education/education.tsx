            ...
            <tbody>
              {educationList.map((education, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{education.employee ? <Link to={`employee/${education.employee.id}`}>{education.employee.id}</Link> : ''}</td>
                  <td>{education.university ? <Link to={`university/${education.university.id}`}>{education.university.id}</Link> : ''}</td>
                  <td>{education.educType ? <Link to={`educ-type/${education.educType.id}`}>{education.educType.id}</Link> : ''}</td>
