    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{projectEntity.idProject}</dd>
          <dt>
            <span id="projectNm">Project Nm</span>
          </dt>
          <dd>{projectEntity.projectNm}</dd>
          <dt>
            <span id="companyNM">Company NM</span>
          </dt>
          <dd>{projectEntity.companyNM}</dd>
          <dt>
            <span id="startDt">Start Dt</span>
          </dt>
          <dd>{projectEntity.startDt ? <TextFormat value={projectEntity.startDt} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="endDt">End Dt</span>
          </dt>
          <dd>{projectEntity.endDt ? <TextFormat value={projectEntity.endDt} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
        </dl>
