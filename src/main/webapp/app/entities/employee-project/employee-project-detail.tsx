    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>Employee</dt>
          <dd>{employeeProjectEntity.employee ? employeeProjectEntity.employee.id : ''}</dd>
          <dt>Project</dt>
          <dd>{employeeProjectEntity.project ? employeeProjectEntity.project.id : ''}</dd>
          <dt>Project Role</dt>
          <dd>{employeeProjectEntity.projectRole ? employeeProjectEntity.projectRole.id : ''}</dd>
        </dl>
