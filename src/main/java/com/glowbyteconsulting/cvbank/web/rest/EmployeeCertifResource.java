...
/**
 * REST controller for managing {@link com.glowbyteconsulting.cvbank.domain.EmployeeCertif}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeCertifResource {
    ...
    public ResponseEntity<EmployeeCertif> createEmployeeCertif(@RequestBody EmployeeCertif employeeCertif) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/employee-certifs/" + result.getId()))
    ...
    public ResponseEntity<EmployeeCertif> updateEmployeeCertif(@RequestBody EmployeeCertif employeeCertif) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, employeeCertif.getId().toString()))
            .body(result);
    }
