...
import com.glowbyteconsulting.cvbank.repository.ResourcePoolRepository;
...
/**
 * REST controller for managing {@link com.glowbyteconsulting.cvbank.domain.ResourcePool}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ResourcePoolResource {
    ...
    public ResponseEntity<ResourcePool> updateResourcePool(@RequestBody ResourcePool resourcePool) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, resourcePool.getId().toString()))
            .body(result);
    }
